...
# Note that replace the images with the images in the folder assets\Next_Gen_Pitch_2025(Photos)

and make sure that the content and the images are visible properly adjust them 